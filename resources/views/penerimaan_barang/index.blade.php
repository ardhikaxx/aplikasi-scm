...
@section('content')
    <div class="card card-custom">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
            ...
            <a href="{{ route('penerimaan_barang.create') }}" class="btn btn-gradient-primary btn-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-group">
                                        <a href="{{ route('detail_penerimaan.index', $d->id_penerimaan) }}" class="btn btn-gradient-info btn-sm">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="{{ route('penerimaan_barang.edit', $d->id_penerimaan) }}" class="btn btn-gradient-warning btn-sm">
                            ...
                            <tr>
                                <td colspan="5">
                                    <div class="empty-state">
                                        ...
                                        <a href="{{ route('penerimaan_barang.create') }}" class="btn btn-gradient-primary btn-sm mt-2">
                                            <i class="bi bi-plus-lg me-1"></i>Tambah Penerimaan
                                        </a>
                                    </div>
                                </td>
